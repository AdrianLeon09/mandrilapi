...
namespace MandrilAPI.Middleware
{
    ...
    public class ExepcionesJsonMiddleware
    {
     ...
     // Guardamos una referencia a él para poder invocarlo y continuar con el flujo de la petición.
       private readonly RequestDelegate _next;
        ...
        private readonly ILogger<ExepcionesJsonMiddleware> _logger;

        public ExepcionesJsonMiddleware(RequestDelegate next, ILogger<ExepcionesJsonMiddleware> logger)
        {
             _next = next;
            _logger = logger;
        }
