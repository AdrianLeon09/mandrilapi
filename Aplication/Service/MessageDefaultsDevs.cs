namespace MandrilAPI.Aplication.Service
{
    public static class MessageDefaultsDevs
    {
        ...
        public const string SkillPowerUpdateSuccess = "The power of skill {EntitySkillID} for mandril {EntityMandrilID}  and User ID {UserId} has been successfully updated. The new value is {EntityPower}";
        public const string CheckPublicUsernamePassed = "Public username validation passed";
        public const string CheckEmailPassed = " Email validation passed";
