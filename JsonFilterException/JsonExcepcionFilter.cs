...
public class JsonExcepcionFilter : IExceptionFilter
{
    private readonly ILogger<JsonExcepcionFilter> _logger;

    public JsonExcepcionFilter(ILogger<JsonExcepcionFilter> logger)
    {
        _logger = logger;
